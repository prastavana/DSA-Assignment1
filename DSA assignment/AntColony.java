...
public class AntColony {
    ...
    public AntColony(int numOfCities, int[][] distanceMatrix, double alpha, double beta, double evaporationRate, int numAnts, int maxIterations) {
    ...
    public static void main(String[] args) {
        ...
        AntColony antColony = new AntColony(numOfCities, distanceMatrix, alpha, beta, evaporationRate, numAnts, maxIterations);
