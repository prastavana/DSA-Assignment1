...
public class Image_Downloader extends JFrame {
    ...
    public Image_Downloader() {
        ...
        getContentPane().setBackground(new Color(242, 226, 255));
    }
    ...
    private void initComponents() {
        ...
        urlPanel.setBackground(new Color(242, 226, 255));
        ...
        buttonPanel.setBackground(new Color(242, 226, 255));
        ...
        progressBar.setBackground(new Color(242, 226, 255));
        add(progressBar);
                    ...
                    public void run() {
                        try {
                            ...
                            try (BufferedInputStream in = new BufferedInputStream(url.openStream());
                                ...
                                while ((bytesRead = in.read(buffer, 0, 1024)) != -1) {
                                    if (cancelDownload) {
                                        SwingUtilities.invokeLater(() -> {
                                            JOptionPane.showMessageDialog(Image_Downloader.this, "Download canceled.");
                                    ...
                                    if (pauseDownload) {
                                        SwingUtilities.invokeLater(() -> JOptionPane.showMessageDialog(Image_Downloader.this, "Download paused."));
                                        while (pauseDownload) {
                                            try {
                                                Thread.sleep(1000);
                                ...
                                SwingUtilities.invokeLater(() -> {
                                    JOptionPane.showMessageDialog(Image_Downloader.this, "Image downloaded successfully.");
                                    progressBar.setValue(0);
                                });
                            }
                        } catch (IOException e) {
                            SwingUtilities.invokeLater(() -> JOptionPane.showMessageDialog(Image_Downloader.this, "Error downloading image: " + e.getMessage()));
                        }
                    }
                });
            }
    ...
    public static void main(String args[]) {
        SwingUtilities.invokeLater(() -> new Image_Downloader().setVisible(true));
    }
}
